...
public class Server {
	...
	//Running this method from inside the main method inside of Client class
	
	/*
	public static void readFile() throws FileNotFoundException, IOException {

            File f = new File("C:/Users/Rakshith/Desktop/CIS427-Project-1-master/CIS 427 P1/src");
            if(f.exists()) {
    ...
    public static void main(String args[]) 
    {
    	  ...
    	  //Open File from desktop - CHANGE: Copied from "readFile()" method inside Client Class
    	  File f = new File("C:/Users/Rakshith/Desktop/CIS427-Project-1-master/CIS 427 P1/src");
          if(f.exists()) {
          	System.out.println("File Exists");
          }
